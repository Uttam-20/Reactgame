...
function Show() {
    ...
    if (x == "") alert("Please Enter a number");
        ...
        if (x == y) {
            ReactDOM.render("Correct!!! Your Final score is " + count + "/10", document.getElementById("result"));
            count = 10;
...
const myrules = (<p>
    <ul>
        ...
        <li>All digits are <b>distinct</b></li>
        <li><b>Refresh the page to play with new number</b></li>
    </ul>
</p>);
function Display() {
    return (<button id="buton" onClick={Show}>Click here</button>);
}
function Open() {
